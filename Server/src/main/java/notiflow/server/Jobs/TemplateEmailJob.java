...
@Component
public class TemplateEmailJob implements Job {
    private final EmailServices emailServices;
    private final ObjectMapper objectMapper;

    @Autowired
    public TemplateEmailJob(EmailServices emailServices, ObjectMapper objectMapper) {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        try {
            emailServices.sendTemplateEmail(emailRequest);
        } catch (Exception e) {
